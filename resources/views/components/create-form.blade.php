             ...
             @switch($type)
                @case('textarea')
                    <div class="pb-5">
                        ...
                        <textarea name="{{$name}}" rows="4" class="block p-2 mt-1 w-full text-sm text-gray-900 rounded-md border border-gray-300 bg-white focus:ring-primary focus:border-primary"></textarea>
