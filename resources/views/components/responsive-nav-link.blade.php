...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-secondary text-left text-base font-medium text-primary bg-accent focus:outline-none focus:text-secondary focus:bg-white focus:border-accent transition duration-150 ease-in-out'
